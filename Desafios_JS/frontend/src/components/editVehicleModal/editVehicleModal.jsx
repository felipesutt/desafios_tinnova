...
export default function EditVehicleModal({modalVisibilityHandler, submitHandler, changeHandler}){
    return(
            ...
            <form className="relative px-8 py-8 h-full text-white" onSubmit={submitHandler}>
                ...
                <div className="flex flex-col h-full pt-16 justify-between">
                    ...
                    <div className="flex justify-end">
                        <button className='bg-[#FFD001] px-2 py-2 rounded-lg text-black font-semibold'>Editar</button>
                    </div>
                </div>
            </form>
        </div>
